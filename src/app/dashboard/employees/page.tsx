  ...
  return (
    <DashboardShell>
      <div className="relative">
        {/* Header - Becomes floating when scrolled */}
        <div 
          ref={headerRef}
          className={`transition-all duration-500 ease-out ${
            isScrolled 
              ? "sticky top-4 mx-8 z-50 px-6 py-3 bg-[#111118]/90 backdrop-blur-xl rounded-2xl border border-white/[0.08] shadow-2xl shadow-black/50"
